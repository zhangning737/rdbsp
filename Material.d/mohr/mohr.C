...
double*
Material_Mohr::getprops(double *p ){
...
double
Material_Mohr::calcmass(double evol)
{
    double density = cm[0];
...
int
Material_Mohr::calcstress(double *sig, double *eps, double *his, double dt, double tt, int& ps,int& fail)
{
    double mm[6];
    mm[0]= cm[1];
    mm[1] =cm[2];
    ...
    matmohr((double*)mm ,(double*)eps,(double*)sig,(double*)his, dt, tt, ps, fail);

    return 0;
}

double
Material_Mohr::getwavespeed()
{
    double rho = cm[0];
    double E = cm[1];
    double mu = cm[2];
...
int
Material_Mohr::matmohr(double* mm, double* eps, double* sig, double* his, double dt, double tt, int& iPlas,int& fail) {
