...
double*
Material_Ela::getprops(double *p ){
...
double
Material_Ela::calcmass(double evol)
{
    double density = cm[0];
...
int
Material_Ela::calcstress(double *sig, double *eps, double *his, double dt, double tt,int& ps,int& fail)
{
    //double mm[2];
    // mm[0]= cm[1];
    //mm[1] =cm[2];
