void
Inverse3(double* jaco, double* ijac, double& det_){
    double idet;
    double jac[3][3];
    ...
    det_ = jac[0][0]*jac[1][1]*jac[2][2]+jac[1][0]*jac[2][1]*jac[0][2]+jac[2][0]*jac[0][1]*jac[1][2]-(jac[2][0]*jac[1][1]*jac[0][2]
                                                                                             +jac[1][0]*jac[0][1]*jac[2][2]+jac[0][0]*jac[2][1]*jac[1][2]);
